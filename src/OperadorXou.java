...
public class OperadorXou {
	...
	public static void main(String[] args) {
		...
		if (umidade > 70 ^ temperatura > 26) {
			System.out.println("Ventiladores ligados");
			}else {
				System.out.println("Por favor, contate o agrônomo.");
			}
